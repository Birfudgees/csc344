/*
  Project 2 synth by Kyle Schaefer, modified from the provided demo plugin.  
  Applied the tail-off feature for quick release on notes and deactivated the pitch-changing function.
*/
